...
echo json_encode($aplicativos[1]);
    ...
    <nav class="Menu navbar navbar-expand topbar static-top shadow ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 120px">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item mr-4"><a href="/ts/sistema/" class="nav-link nav-link-menu <?php if ($url == "/ts/sistema/") { echo " active ";} ?>">Sistema</a></li>
                <li class="nav-item mr-4"><a href="/ts/services/" class="nav-link nav-link-menu <?php if ($url == "/ts/services/") {echo " active ";} ?>">Services</a></li>
                <li class="nav-item mr-4"><a href="/ts/cadastros/" class="nav-link nav-link-menu <?php if ($url == "/ts/cadastros/") {echo " active ";} ?>">Cadastros</a></li>
                <li class="nav-item mr-4"><a href="/ts/paginas/" class="nav-link nav-link-menu <?php if ($url == "/ts/paginas/") {echo " active ";} ?>">Paginas</a></li>
                <li class="nav-item mr-4"><a href="/ts/impostos/" class="nav-link nav-link-menu <?php if ($url == "/ts/impostos/") {echo " active ";} ?>">Impostos</a></li>
