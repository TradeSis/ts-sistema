...
<body class="bg-transparent">
    ...
    <div class="container" style="margin-top:10px">
        ...
        <div class="row mt-4">
            <div class="col-sm-8">
                <h3 class="col">Adicionar Noticia</h3>
            </div>
        ...
        <div class="container" style="margin-top: 10px">
            ...
            <form action="../database/noticias.php?operacao=inserir" method="post" enctype="multipart/form-data">

                <div class="row">
                    <div class="col-sm-12" style="margin-top: 10px">
                        <div class="form-group">
                            <label class='control-label' for='inputNormal' style="margin-top: -20px;">Titulo*</label>
                            <input type="text" name="tituloNoticia" class="form-control" required autocomplete="off">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3" style="margin-top: 10px">
                        <div class="form-group">
                            ...
                            <textarea name="conteudoNoticia" id="" cols="135" rows="10"></textarea>
                        </div>
                    </div>
                </div>
