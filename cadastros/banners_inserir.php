...
<body class="bg-transparent">
    ...
    <div class="container" style="margin-top:10px">
        ...
        <div class="row mt-4">
            <div class="col-sm-8">
                <h3 class="col">Adicionar Banner</h3>
            </div>
        ...
        <div class="container" style="margin-top: 10px">
            ...
            <form action="../database/banners.php?operacao=inserir" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-3" style="margin-top: 50px">
                        <div class="col-sm-6" style="margin-top: -20px">
                            ...
                            <input type="file" name="imgBanner" id="foto">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3" style="margin-top: 90px">
                        <div class="form-group">
                            ...
                            <input type="titulo" name="nomeBanner" class="form-control" required autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3" style="margin-top: 90px">
                        <div class="select-form-group">
                            ...
                            <select class="select form-control" name="statusBanner">
