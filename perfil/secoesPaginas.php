...
/* echo json_encode($secoesPaginas); */
            ...
            <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="secoesPaginas_editar.php?idSecaoPagina=<?php echo $secoesPagina['idSecaoPagina'] ?>" role="button">Editar</a>
